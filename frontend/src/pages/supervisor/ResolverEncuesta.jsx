...
export default function ResolverEncuestaSupervisor() {
  const { codigo } = useParams(); // ruta: /supervisor/encuestas/:codigo
  ...
  useEffect(() => {
    fetch(`/supervisor/encuestas/${codigo}`, {
  ...
  const enviarFormulario = async () => {
    ...
    const res = await fetch(`/supervisor/encuestas/${codigo}/responder`, {
      method: "POST",
      headers: {
