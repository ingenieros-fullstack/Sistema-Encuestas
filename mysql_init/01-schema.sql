...
-- =========================================  
-- Tabla: secciones (con campos condicionales)  
-- =========================================  
...
CREATE TABLE secciones (  
  ...
  condicion_pregunta_id INT DEFAULT NULL,  
  condicion_valor VARCHAR(255) DEFAULT NULL,  
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,  
  FOREIGN KEY (codigo_formulario) REFERENCES formularios(codigo) ON DELETE CASCADE  
) ENGINE=InnoDB;  
  
CREATE INDEX idx_secciones_formulario ON secciones (codigo_formulario);  
CREATE INDEX idx_secciones_condicion ON secciones (condicion_pregunta_id);  
  
-- =========================================  
-- Tabla: preguntas (con updated_at)  
-- =========================================  
...
-- =========================================  
-- Tabla: opciones (para preguntas múltiples/únicas)  
-- =========================================  
...
CREATE TABLE asignaciones (  
  ...
  fecha_respuesta TIMESTAMP NULL,  -- 👈 Columna faltante  
