...
-- =========================================  
-- Tabla: preguntas (CORREGIDA con opciones y updated_at)  
-- =========================================  
...
FOR EACH ROW  
BEGIN  
  DECLARE default_pass VARCHAR(100);  
  SET default_pass = '$2a$10$YourHashedPasswordHere';  
    
  INSERT INTO usuarios (id_data, correo_electronico, password, rol, estatus, must_change_password)  
  VALUES (NEW.id_data, NEW.correo_electronico, default_pass, 'empleado', 1, 1);  
END$$  
DELIMITER ;